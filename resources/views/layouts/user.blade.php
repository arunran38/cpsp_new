...
<body class="h-full font-sans antialiased text-slate-900 bg-slate-50/50 selection:bg-indigo-500/30 relative" x-data="{ sidebarOpen: false }">

    <!-- Colorful Ambient Background -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div class="absolute -top-40 -left-40 w-96 h-96 rounded-full bg-gradient-to-br from-indigo-400/30 to-purple-400/30 blur-[100px] mix-blend-multiply"></div>
        <div class="absolute top-1/2 left-1/3 w-96 h-96 rounded-full bg-gradient-to-tr from-rose-400/20 to-orange-400/20 blur-[100px] mix-blend-multiply transition-transform duration-1000"></div>
        <div class="absolute -bottom-40 -right-40 w-[30rem] h-[30rem] rounded-full bg-gradient-to-tl from-blue-400/30 to-cyan-400/30 blur-[100px] mix-blend-multiply"></div>
    </div>
    ...
    <div class="min-h-full relative z-10">
        ...
        <div class="lg:pl-72 flex flex-col min-h-screen">
            <!-- Top Navigation -->
            <header class="sticky top-0 z-30 flex items-center h-20 px-4 bg-white/60 backdrop-blur-xl border-b border-white/40 sm:px-6 lg:px-8 shadow-sm">
