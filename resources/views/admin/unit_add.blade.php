...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex flex-col gap-1">
        <h1 class="text-2xl font-bold tracking-tight text-slate-900">Add New Unit</h1>
        <p class="text-sm text-slate-500">Create a new organizational unit in the system.</p>
    </div>
